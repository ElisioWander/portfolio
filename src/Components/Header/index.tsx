      ...
      <header className="w-full h-full max-w-[1280px] m-auto px-4 md:px-8 flex items-center justify-between text-zinc-200 ">
        ...
        <Navigation>
          ...
          <NavigationItem
            url="#contact"
            name="Contato"
            contactButton="w-[120px] h-11 ml-10 inline-flex items-center justify-center rounded border-2 border-solid border-purple-100 hover:brightness-75 transition-all bg-zinc-700 "
          />
        </Navigation>
      </header>
    </div>
